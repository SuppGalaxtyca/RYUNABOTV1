...
/////////////////
const BotName = 'RYUNABOT地獄'; 
const instagram = 'https://www.instagram.com/suppffftt'; 
const whatsapp = 'https://wa.me/6281284160630'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UCf9sIv4CL5jvrsGno9OR8-Q';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@suppffftt')
